...
## Версия 25.1.0 от 14.02.2025
- Реализована возможность фильтрации на сцене вспомогательных геометрических тел, таких как "заполнители проёмов" и "заполнители помещений". <!--3-3046-->
- Добавлено расширение [**RenderOptionsExtension**](../extensions3d/embedded/RenderOptions) для управления видимостью вспомогательных обьектов на сцене. <!--3-3047-->
- Исправлены ошибки:
  - Исправлено скрытие ребер выделенных объектов в процессе поворота модели на сцене. <!--3-2984--><!--25.1.0 от 14.02.2025-->

## Версия 24.24.0 от 28.12.2024
- Реализовано API для отрисовки пересечений объектов информационных моделей на сцене. <!--3-2697-->
- Реализован индикатор загрузки файлов модели и облаков точек, прогресс обработки и подготовки к отображению их на сцене. <!--3-2621-->
- В режиме затенения на сцене добавлено подсвечивание рёбер и граней объекта при наведении на него курсора. <!--3-2756-->
- Оптимизирована загрузка моделей на сцену. <!--3-2352-->
- Исправлены ошибки:
  - Исправлена ошибка очищения сцены с моделью при повторной загрузке уже загруженной модели, если использовалась [OPFS](../requirements/#оптимизация-производительности-при-работе-с-моделями). <!--3-2691-->
  - Исправлена некорректная работа гизмо для секущих кубов и плоскостей при переключении режимов ортогонального и перспективного видов. <!--3-2808-->
...
- Реализована опция **Скрывать маленькие объекты** в диалоге **Настройки отображения** модели. <!--3-92-->
- Реализовано добавление фантомных узлов в дерево модели в случае, если в дереве  есть элемент, который  содержит дочерние узлы и  геометрию. <!--3-2440-->
- Доработано расширение [PilotWeb3D.Remarks](../extensions3d/RemarksExtension). Добавлена опция выделения объекта, связанного с замечанием, при выборе замечания в списке. Добавлены события: 
  - [pilotRemarkSelectionChanged](../extensions3d/RemarksExtension#pilotRemarkSelectionChanged) -- событие изменения списка селектированных замечаний,
  - [pilotRemarkPlacingModeChanged](../extensions3d/RemarksExtension#pilotRemarkPlacingModeChanged) -- событие изменения режима размещения замечаний на сцене. <!--3-2503-->
