...
- Доработано расширение [PilotWeb3D.Remarks](../extensions3d/RemarksExtension). Добавлена опция выделения объекта связанного с замечанием при селектировании замечания. Добавлены события: 
