...
- Реализовано [API](../bim-dataprovider/IBimDataPart) для отрисовки пересечений объектов информационных моделей на сцене. <!--3-2697-->
...
- Исправлены ошибки:
  - Исправлена ошибка очищения сцены с моделью при повторной загрузке уже загруженной модели, если использовалась <a href="https://help.pilotems.com/ru/Content/web_overview.htm">OPFS</a>. <!--3-2691-->
