...
- Реализован ортогональный вид моделей на сцене. <!--3-46-->
- Реализован переход к ортогональному виду при клике на грани видового куба. <!--3-2091 мимо релнотсорса-->
- Реализовано чтение свойств облаков точек. <!--origin/show-cloud-properties мимо релнотсорса-->
- Исправлены ошибки:
  - Откорректировано отображение осей гизмо. <!--3-2099-->
  - Исправлена ошибка "Cannot read properties of undefined (reading 'buffer')" при открытии карточки документа в некоторых сценариях. <!--3-2123 мимо релнотсорса-->
