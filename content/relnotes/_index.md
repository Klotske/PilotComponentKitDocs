...
- Реализовано API для сохранения куба сечения.
- Добавлен компонент [Pilot BIM Dataprovider](../bim-dataprovider/) для чтения файлов .bm моделей и .cloudbm облаков точек.
- Исправлены ошибки:
