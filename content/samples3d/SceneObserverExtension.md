...
```html
<link rel="stylesheet" href="https://pilot.ascon.ru/componentkit/components/@VERSION@/samples/SceneObserverExtension/SceneObserverExtension.css">
<script src="https://pilot.ascon.ru/componentkit/components/@VERSION@/samples/SceneObserverExtension/SceneObserverExtension.js"></script>
```
