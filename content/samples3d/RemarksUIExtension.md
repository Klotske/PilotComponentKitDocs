...
```html
<link rel="stylesheet" href="https://pilot.ascon.ru/componentkit/components/@VERSION@/samples/RemarksUIExtension/RemarksUIExtension.css">
<script src="https://pilot.ascon.ru/componentkit/components/@VERSION@/samples/RemarksUIExtension/RemarksUIExtension.js"></script>
```
