...
## Добавить 3D компонет на HTML страницу

Следующий код показывает как добавить компонет работы с BIM-моделью на вашу HTML страницу.
...
Следующий код показывает как добавить компонет работы с 2D документами на вашу HTML страницу.
...
Размер пакетов Pilot.Web.3D и Pilot.Web.2D не маленькуи, по-это мы рекомендуем подключать эти библиотеки к HTML странице как можно позже.