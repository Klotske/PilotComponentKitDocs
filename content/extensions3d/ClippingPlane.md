...
```
где:\
`planeIDs` -- список идентификаторов плоскостей сечения. Не обязательный параметр. Если не задан, то возвращается описание всех плоскостей сечения.
...
```
где:\
`planeIDs` -- список идентификаторов плоскостей сечения. Не обязательный параметр. Если не задан, то удаляются все плоскости сечения.
